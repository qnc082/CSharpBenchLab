...
All benchmark results are automatically exported as GitHub-flavored Markdown files and saved to the [`/Docs/Results`](./Docs/Results) directory. This makes it easy to view and compare results directly in the repository.
